...
import com.sysco.test.api.requests.data.UserDataReference;
...
public class GetEmployeeDetailsTest extends TestBase {
    ...
    public static void testGetProject() {
      ...
      //  softAssert.assertEquals(responseModel.data.get(0).id, Constant.TestDataFilePath.EMPLOYEE_DATA_JSON_FILE, AssertErrorMessages.INVALID_EMPLOYEE_ID);
