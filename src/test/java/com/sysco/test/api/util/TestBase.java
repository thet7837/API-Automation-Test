...
public class TestBase {
    ...
    public void init() {
        ...
        commonModelGETEmployeesDetailsList = APIDataUtil.getCommonTHAPIModelFromDataJSONFile(Constant.TEST_RESOURCE_PATH, Constant.TestDataFilePath.INPUT_EMPLOYEE_DATA_JSON_FILE);
    }
}
